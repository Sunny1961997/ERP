...
<main class="page-content">
	...
	<div class="container-fluid">
      ...
      <div class="form-group">
      	<form class="form-horizontal" action="{{ route('advancepayment.store') }}" method="post" enctype="multipart/form-data">
      		@csrf
          <div class="row">
              <hr class="w-100">
              ...
              <div class="col-md-3 col-sm-12  form-group">
                ...
                <div>
                  <input type="text" name="order_id" class="form-control" id="supplier_address">
                </div>
              </div>
              ...
              <div class="col-md-3 col-sm-12  form-group">
                ...
                <div>
                  <input type="text" name="narration" class="form-control" id="supplier_address">
                </div>
              </div>
                            ...
                            <tbody>
                                @foreach($advancepayments as $advancepayment)
                                    <tr>
                                        ...
                                        <td>{{ $advancepayment->narration}}</td>
                                        <td>{{ $advancepayment->date}}</td>
                                    </tr>
                                @endforeach    
                            </tbody>
                            <tfoot>
